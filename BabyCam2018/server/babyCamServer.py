# babyCamServer.py
# babyState import해서 안에있는 findStateForImage() 함수 사용하기
# 시간 설정해 우는상태가 나온 시점부터 10초간 배열에 저장,
#   우는상태가 지속적으로 많을 경우 우는상태라고 리턴하기.
# 리턴한 값(True)일 경우 안드로이드로 보내주기

import face9_4 as face
import cv2
import datetime
import socket
import time
